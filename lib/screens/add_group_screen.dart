...
class _AddGroupScreenState extends State<AddGroupScreen> {
  ...
  void _submit() async {
    ...
    if (_selectedDeviceIds.isEmpty) {
      ToastUtils.show(context, 'Harus memilih setidaknya satu kamera!', isError: true);
      return;
    }
      ...
      if (result['success'] == true) {
        ...
        if (_selectedDeviceIds.isNotEmpty) {
          for (var cameraId in _selectedDeviceIds) {
             ...
             if (assignRes['success'] == true) successCount++;
             else errorCount++;
          }
        }
        ...
        if (mounted) {
          ...
          if (successCount > 0) message += ' ($successCount kamera ditambahkan)';
        ...
        if (mounted) {
          setState(() => _isSubmitting = false);
          ToastUtils.show(context, result['message'] ?? 'Gagal membuat grup.', isError: true);
        }
      }
    } else {
                ...
                _isSubmitting
                  ...
                  : ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        backgroundColor: canCreateGroup ? null : Colors.grey,
                      ),
