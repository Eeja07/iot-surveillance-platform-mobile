...
void main() {
  group('ErrorBoundary Tests', () {
    testWidgets('Renders child when no error occurs', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: ErrorBoundary(
            child: Container(key: const Key('child_widget')),
          ),
        ),
      );
    ...
    testWidgets('Catches error and displays fallback UI even when outside MaterialApp',
